...
class MainWindow(QMainWindow):
	def __init__(self):
		...
		self.cardGrid.setSpacing(0)
		self.cardGrid.setContentsMargins(0,0,0,0)

		self.cardGrid.addWidget(self.k1Button, 0, 0)
		self.cardGrid.addWidget(self.d1Button, 0, 1)
		self.cardGrid.addWidget(self.k2Button, 0, 2)
		self.cardGrid.addWidget(self.d4Button, 1, 0)
		self.cardGrid.addWidget(self.aButton, 1, 1)
		self.cardGrid.addWidget(self.d2Button, 1, 2)
		self.cardGrid.addWidget(self.k3Button, 2, 0)
		self.cardGrid.addWidget(self.d3Button, 2, 1)
		self.cardGrid.addWidget(self.k4Button, 2, 2)
		...
		self.sixSlotGUI = QHBoxLayout()
		self.sixSlotGUI.addWidget(self.sixButton)

		self.startButG = QHBoxLayout()
		self.startButG.addWidget(self.startButton)

		self.drawDiscButtons = QHBoxLayout()
		self.drawDiscButtons.addWidget(self.drawButton)
		self.drawDiscButtons.addWidget(self.discardButton)
		...
		self.background = QLabel("asd")
		self.background.setPixmap(QPixmap("table.jpg"))
		...
		self.bgAndButtons = QWidget()
		self.bgAndButtons.setLayout(self.layout)
		self.setCentralWidget(self.bgAndButtons)

		self.startGUI = QWidget()
		self.startGUI.setLayout(self.startButG)
		self.startGUI.setParent(self.bgAndButtons)
		self.startGUI.setGeometry(100, 50, 100, 100)
		self.startGUI.raise_()
	...
	def startGame(self):
		...
		self.cardSlots = QWidget()
		self.cardSlots.setLayout(self.cardGrid)
		self.cardSlots.setParent(self.bgAndButtons)
		self.cardSlots.setGeometry(250, 150, 500, 500)
		self.cardSlots.raise_()

		self.deckSlot = QWidget()
		self.deckSlot.setLayout(self.drawDiscButtons)
		self.deckSlot.setParent(self.bgAndButtons)
		self.deckSlot.setGeometry(50, 650, 300, 200)
		self.deckSlot.raise_()

		self.sixGUI = QWidget()
		self.sixGUI.setLayout(self.sixSlotGUI)
		self.sixGUI.setParent(self.bgAndButtons)
		self.sixGUI.setGeometry(750, 650, 200, 200)
		self.sixGUI.raise_()
