...
#Build deck
def build_deck():
    deck = aces|diamonds|clubs|hearts
    return deck

deck = build_deck()

#Another idea is dictionaries, can be used to associate the card name with a numerical value, could be used in determining whether a card is able to be placed on another, might be easier than using list indeces
